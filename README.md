...
The follwoing instructions will help you deploy a Streamlit app in a python environment on you Mac, feel free to checkout their docs and other examples [here](https://streamlit.io).
